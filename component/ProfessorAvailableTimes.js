...

                    {
                        Array.isArray(availableTimes) && availableTimes.map(aT =>
                            ...
                            <tr key={aT.available_ID}>
                                ...
                                <td>{aT.end_time}</td>
                                <td>{aT.date}</td>
                                <td><Button type="button" onClick={() => {if (window.confirm('Are you sure you wish to remove this appointment?')) deleteAvailableTimes(aT.available_ID)}}>Delete</Button></td>
                            </tr>
                            </tbody>
                        )
                    }
